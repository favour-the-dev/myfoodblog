...
function Navbar() {
    ...
    return ( 
        <>
            <nav className={`w-full p-3 z-50
                ${pathName === "/" ? "bg-[#647403] text-[#FFFEF6]" : "bg-[#F9F7EB] text-[#647403]" }  
                ...
                <div className="max-cont flex-row-between">
                        ...
                        <div className="md:hidden">
                            <div className="text-3xl font-bold relative z-40" onClick={() => setNavOpen((prevState:boolean)=> !prevState)}>
                            {
                            ...
                            <div onClick={()=> setTimeout(()=>{
                                setNavOpen(false)
                            }, 1500)} className={`w-full ${pathName === "/" ? "bg-[#647403] text-[#FFFEF6]" : "bg-[#F9F7EB] text-[#647403]" } flex flex-col justify-center p-5 gap-5 absolute top-[100%] left-0 duration-300 ease-in-out ${navOpen ? 'opacity-100 h-[100dvh]' : 'opacity-0 h-0'}`}>
                                ...
                                <Link  href={'/mobileSearch'} className="text-xl w-fit relative">
                                    <input type="text" 
                                    className={`border ${pathName === "/" ? "border-[#FFFEF6] text-[#FFFEF6]" : "border-[#647403] text-[#647403]" } rounded-3xl px-4 py-2 focus:outline-none`} 
